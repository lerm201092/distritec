	...
	<div class="container header_t">
		<div class="row">
			<div class="col-md-6" style="padding-left: 30px;">
				<div class="logo">
					<a href="index.php"><img src="../../distritec_img/img_app/logo.jpg" alt="Logo"/></a>
				</div>
			</div>
...
<div class="row menu_gris" id="menu_principal">
	<div class="container" id="menu_principal_cont" style="padding:0">
		...
		<li class="item_menu" id="li_desechables" style="width:16%">
			...
			<div style="padding-top: 20px;">
			<!-- <ul  id="submenu_envases"> -->
				<ul  id="submenu_desechables" style="display:none">
					<li id="top_li"></li>
					<li><a href="./productos.php?tipo=desechables&linea=B">Biodegradables</a></li>
					<li><a href="./productos.php?tipo=desechables&linea=C">Convencionales</a></li>	
				</ul>			
			</div>
