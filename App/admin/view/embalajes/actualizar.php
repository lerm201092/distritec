...
<script src="../../controller/embalajes/actualizar.js"></script>
		...
		<!-- Header del contenido -->
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Embalajes</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item">Embalajes</li>
									...
									<div class="row">										
										<div class="col-12 text-center">
											...
											<div class="col-12 text-right" style="padding-top: 20px;">
												<input type='hidden' name='tabla' value='EMBALAJES'>
