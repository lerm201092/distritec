...
$(document).ready(function(){
    $("#menu-derecha").html(`<li class="nav-item"><a href="../estibas/agregar.php" class="nav-link"><i class="nav-icon fa fa-plus" style="padding-right:15px;"></i><b>Registrar Prodcuto</b></a></li>`)
    CargarTabla();
});
